...
<form method="post" action="" id="admbike-rule-form" style="max-width:700px;">
	...
	<fieldset id="admbike-match-fields" style="border:1px solid #ccc;padding:15px;margin-bottom:20px; border-radius:4px;">
		...
		<table class="form-table" style="margin-bottom:0;">
			...
			<tbody id="admbike-field-postcode" class="admbike-match-group" style="<?php echo 'postcode' !== $match_type ? 'display:none;' : ''; ?>">
				<tr>
					<th scope="row">
						<label for="postcode_code"><?php esc_html_e( 'Postcode', 'admbike-woo-locations' ); ?> <span style="color:#d63638;" id="admbike-pc-required">*</span>
						</label>
					</th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'Enter a 5-digit postcode.', 'admbike-woo-locations' ); ?></p>
					</td>
				</tr>
			</tbody>
	...
	<table class="form-table">
		...
		<tr>
			<th scope="row">
				<label for="rule_title"><?php esc_html_e( 'Rule Title', 'admbike-woo-locations' ); ?> <span style="color:#d63638;">*</span></label>
			</th>
			<td>
				<input type="text" id="rule_title" name="rule_title" class="regular-text" required
					value="<?php echo esc_attr( $selected_rule_title ); ?>"
					placeholder="<?php esc_attr_e( 'e.g. Envíos a GDL', 'admbike-woo-locations' ); ?>">
				<p class="description"><?php esc_html_e( 'Internal name used only in the admin list.', 'admbike-woo-locations' ); ?></p>
			</td>
		</tr>
